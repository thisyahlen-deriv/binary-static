...
const CryptoConfig = (() => {
    ...
    const initCryptoConfig = () => ({
        ...
        DAI: {
            display_code     : 'DAI',
            name             : localize('Multi-Collateral'),
            min_withdrawal   : 0.002,
            pa_max_withdrawal: 5,
            pa_min_withdrawal: 0.002,
        },
